...
This project is indexed by GitNexus as **inspect** (2036 symbols, 6681 relationships, 121 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/inspect/context` | Codebase overview, check index freshness |
| `gitnexus://repo/inspect/clusters` | All functional areas |
| `gitnexus://repo/inspect/processes` | All execution flows |
| `gitnexus://repo/inspect/process/{name}` | Step-by-step execution trace |
