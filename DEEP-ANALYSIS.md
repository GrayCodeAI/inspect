...
**Status: REMOVED** — Web dashboard removed to focus on CLI/REPL-first development.
...
4. **Documentation lag** — roadmaps don't reflect actual implementation state
