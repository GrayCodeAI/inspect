...
export class RequiresFullDiskAccess extends Schema.ErrorClass<RequiresFullDiskAccess>("RequiresFullDiskAccess")({
  _tag: Schema.tag("RequiresFullDiskAccess"),
}) {
  message = "Safari requires Full Disk Access. Please grant it in System Settings > Privacy & Security.";
}
...
export class CookieDatabaseNotFoundError extends Schema.ErrorClass<CookieDatabaseNotFoundError>("CookieDatabaseNotFoundError")({
...
export class CookieDatabaseCopyError extends Schema.ErrorClass<CookieDatabaseCopyError>("CookieDatabaseCopyError")({
...
export class CookieDecryptionKeyError extends Schema.ErrorClass<CookieDecryptionKeyError>("CookieDecryptionKeyError")({
...
export class UnsupportedPlatformError extends Schema.ErrorClass<UnsupportedPlatformError>("UnsupportedPlatformError")({
...
export class UnsupportedBrowserError extends Schema.ErrorClass<UnsupportedBrowserError>("UnsupportedBrowserError")({
