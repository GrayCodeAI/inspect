...
export class CaptchaDetector extends ServiceMap.Service<CaptchaDetector>()(
  "@captcha/CaptchaDetector",
  {
    make: Effect.gen(function* () {
      const detectFromPage = Effect.fn("CaptchaDetector.detectFromPage")(
        function* (_pageUrl: string, _pageContent: string) {
      ...
      const detectReCaptcha = Effect.fn("CaptchaDetector.detectReCaptcha")(
      ...
      const detectHCaptcha = Effect.fn("CaptchaDetector.detectHCaptcha")(
        function* (content: string) {
      ...
      const detectCloudflare = Effect.fn("CaptchaDetector.detectCloudflare")(
        function* (content: string) {
