...
// Specialist prompts
export { UX_SPECIALIST_PROMPT, UX_EVALUATION_CRITERIA, buildUXInstruction } from "./prompts/specialists/ux.js";
export { SECURITY_SPECIALIST_PROMPT, XSS_PAYLOADS, SQLI_PAYLOADS, buildSecurityInstruction } from "./prompts/specialists/security.js";
export { A11Y_SPECIALIST_PROMPT, WCAG_CHECKS, buildA11yInstruction } from "./prompts/specialists/a11y.js";
export { PERFORMANCE_SPECIALIST_PROMPT, PERFORMANCE_THRESHOLDS, rateMetric, buildPerformanceInstruction } from "./prompts/specialists/performance.js";
...
export { ContextCompactor, type CompactionOptions, type CompactionResult } from "./memory/compaction.js";
...
export { PermissionsWatchdog, type PermissionRequest, type PermissionRule } from "./watchdogs/permissions.js";
...
// Loop detection
export { LoopDetector, type ActionRecord, type LoopDetection, type LoopNudge } from "./loop/detector.js";
