...
const aria: A11yRuleDefinition[] = [
  ...
  },
  {
    ...
    impact: "minor",
    tags: ["wcag2a", "cat.aria"],
    description: "ARIA role must be allowed for the element",
  },
  {
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.aria"],
    description: "ARIA dialog and alertdialog nodes must have an accessible name",
  },
  {
    id: "aria-hidden-body",
    impact: "critical",
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.aria"],
    description: "aria-roledescription must be on semantic roles",
  },
  {
    id: "aria-roles",
    impact: "critical",
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.aria"],
    description: "ARIA treeitem nodes must have an accessible name",
  },
  {
    id: "aria-valid-attr",
    impact: "critical",
...
const color: A11yRuleDefinition[] = [
  ...
  },
  {
    ...
    description: "Links within text blocks must be distinguishable without color",
  },
];
...
const forms: A11yRuleDefinition[] = [
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag21a", "cat.forms"],
    description: "Label and name from content must match",
  },
  {
    id: "label-title-only",
    impact: "serious",
    tags: ["wcag2a", "cat.forms"],
    description: "Form elements should not have title attribute as their only label",
  },
  {
    id: "select-name",
    impact: "critical",
...
const keyboard: A11yRuleDefinition[] = [
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.keyboard"],
    description: "Disabled elements should not be in tab order",
  },
  {
    id: "focusable-modal-open",
    impact: "serious",
    tags: ["wcag2a", "cat.keyboard"],
    description: "Focus must be managed when a modal dialog opens",
  },
  {
    id: "focusable-no-name",
    impact: "serious",
    tags: ["wcag2a", "cat.keyboard"],
    description: "Focusable elements must have an accessible name",
  },
  {
...
const language: A11yRuleDefinition[] = [
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.language"],
    description: "html element lang attribute must have a valid value",
  },
  {
...
const nameRoleValue: A11yRuleDefinition[] = [
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.name-role-value"],
    description: "Documents must have title element to aid navigation",
  },
  {
    id: "duplicate-id",
    impact: "minor",
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.name-role-value"],
    description: "Active element IDs must be unique",
  },
  {
  ...
  },
  {
    ...
    impact: "minor",
    tags: ["wcag2a", "cat.name-role-value"],
    description: "Image alt text must not duplicate adjacent text",
  },
  {
    id: "link-name",
    impact: "serious",
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.name-role-value"],
    description: "Elements with role='img' must have alt text",
  },
  {
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.name-role-value"],
    description: "SVG elements with img role must have alt text",
  },
];
...
const semantics: A11yRuleDefinition[] = [
  {
    id: "definition-list",
    impact: "serious",
    tags: ["wcag2a", "cat.semantics"],
    description: "dl elements must only contain dt and dd groups, div, script, or template",
  },
  {
    id: "dlitem",
    impact: "serious",
    tags: ["wcag2a", "cat.semantics"],
    description: "dt and dd elements must be in a dl",
  },
  {
  ...
  },
  {
    ...
    impact: "moderate",
    tags: ["wcag2a", "cat.semantics"],
    description: "Aside must not be within another landmark",
  },
  {
  ...
  },
  {
    ...
    impact: "moderate",
    tags: ["wcag2a", "cat.semantics"],
    description: "Page must not have more than one banner landmark",
  },
  {
    id: "landmark-no-duplicate-contentinfo",
    impact: "moderate",
    tags: ["wcag2a", "cat.semantics"],
    description: "Page must not have more than one contentinfo landmark",
  },
  {
  ...
  },
  {
    ...
    impact: "moderate",
    tags: ["wcag2a", "cat.semantics"],
    description: "Landmarks must have a unique role or accessible name",
  },
  {
    id: "list",
    impact: "serious",
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.semantics"],
    description: "li elements must be in a ul or ol",
  },
  {
    id: "p-as-heading",
    impact: "serious",
    tags: ["wcag2a", "cat.semantics"],
    description: "Bold styled text must not be used as headings",
  },
];
...
const structure: A11yRuleDefinition[] = [
  {
    id: "bypass",
    impact: "serious",
    tags: ["wcag2a", "cat.structure"],
    description: "Page must have means to bypass repeated blocks of content",
  },
  {
    id: "heading-order",
    impact: "moderate",
  ...
  },
  {
    ...
    impact: "minor",
    tags: ["wcag2aaa", "cat.structure"],
    description: "Links with the same name must have the same purpose",
  },
  {
    id: "meta-refresh",
    impact: "critical",
...
const tables: A11yRuleDefinition[] = [
  {
    ...
    impact: "minor",
    tags: ["wcag2a", "cat.tables"],
    description: "Table caption and summary must not be the same",
  },
  {
    id: "table-fake-caption",
    impact: "serious",
    tags: ["wcag2a", "cat.tables"],
    description: "Data table caption must use caption element",
  },
  {
    id: "td-has-header",
    impact: "critical",
    tags: ["wcag2a", "cat.tables"],
    description: "Data cells in large tables must have associated header",
  },
  {
    id: "td-headers-attr",
    impact: "serious",
    tags: ["wcag2a", "cat.tables"],
    description: "Cells using headers attribute must refer to valid headers",
  },
  {
...
const textAlternatives: A11yRuleDefinition[] = [
  ...
  },
  {
    ...
    impact: "minor",
    tags: ["wcag2a", "cat.text-alternatives"],
    description: "Table header text must not be empty",
  },
  {
    id: "frame-tested",
    impact: "critical",
    tags: ["wcag2a", "cat.text-alternatives"],
    description: "iframes must be tested with axe-core",
  },
  {
  ...
  },
  {
    ...
    impact: "moderate",
    tags: ["wcag2a", "cat.text-alternatives"],
    description: "Video or audio elements must not autoplay audio",
  },
  {
    id: "presentation-role-conflict",
    impact: "minor",
    tags: ["wcag2a", "cat.text-alternatives"],
    description: "Elements with role=none/presentation must not have global ARIA attributes",
  },
  {
    id: "server-side-image-map",
    impact: "minor",
    tags: ["wcag2a", "cat.text-alternatives"],
    description: "Server-side image maps should not be used",
  },
  {
    id: "video-caption",
    impact: "critical",
...
const timeAndMedia: A11yRuleDefinition[] = [
  {
    id: "audio-caption",
    impact: "critical",
    tags: ["wcag2a", "cat.time-and-media"],
  ...
  },
  {
    ...
    impact: "serious",
    tags: ["wcag2a", "cat.time-and-media"],
    description: "blink element must not be used",
  },
  {
    id: "marquee",
    impact: "serious",
    tags: ["wcag2a", "cat.time-and-media"],
    description: "marquee element must not be used",
  },
  {
    id: "video-description",
    impact: "critical",
    tags: ["wcag2a", "cat.time-and-media"],
    description: "Video elements must have audio description",
  },
];
