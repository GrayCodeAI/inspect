 ...
 */
export function registerSessionRoutes(server: APIServer, sessionManager: SessionManager): void {
  // POST /api/sessions
  server.post("/api/sessions", async (req: APIRequest, res: APIResponse) => {
    try {
  ...
  // GET /api/sessions
  server.get("/api/sessions", (req: APIRequest, res: APIResponse) => {
  ...
  // GET /api/sessions/:id
  server.get("/api/sessions/:id", (req: APIRequest, res: APIResponse) => {
  ...
  server.delete("/api/sessions/:id", async (req: APIRequest, res: APIResponse) => {
    try {
