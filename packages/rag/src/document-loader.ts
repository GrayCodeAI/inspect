...
export class DocumentLoader extends ServiceMap.Service<DocumentLoader>()("@rag/DocumentLoader", {
  make: Effect.gen(function* () {
    const loadFromFile = Effect.fn("DocumentLoader.loadFromFile")(function* (path: string) {
    ...
    const loadRaw = Effect.fn("DocumentLoader.loadRaw")(function* (
      content: string,
    ...
    const loadMany = Effect.fn("DocumentLoader.loadMany")(function* (
      sources: ReadonlyArray<DocumentSource>,
    ) {
