...
const _NEWSLETTER_ARTBOARD_LEFT_PX = FAQ_ARTBOARD_LEFT_PX;
...
const _NEWSLETTER_INPUT_SKELETON_LEFT_PX = 59;
const _NEWSLETTER_INPUT_SKELETON_TOP_PX = 327;
const NEWSLETTER_INPUT_SKELETON_WIDTH_PX = 141;
const _NEWSLETTER_INPUT_SKELETON_HEIGHT_PX = 9;
...
const _DASHBOARD_RT_ARTBOARD_LEFT_PX = FAQ_ARTBOARD_LEFT_PX;
...
const _CHECKOUT_PAPER_ARTBOARD_LEFT_PX = FAQ_ARTBOARD_LEFT_PX;
...
const _CHECKOUT_FIELD_PLACEHOLDER_LABELS = ["Email", "Password", "Confirm"];
const _CHECKOUT_FIELD_SKELETON_LEFT_PX = 94;
