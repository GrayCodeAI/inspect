...
export class DOMCapture extends ServiceMap.Service<DOMCapture, {
  ...
  static layer = Layer.effect(this,
    Effect.gen(function* () {
      ...
      const captureAria = () => Effect.gen(function* () {
        return new AriaNode({ role: "root", name: "", children: [], ref: "root" });
      });

      const captureHybrid = () => Effect.gen(function* () {
        return new DOMSnapshot({
          url: "",
          title: "",
          ariaTree: new AriaNode({ role: "root", name: "", children: [], ref: "root" }),
      ...
      const waitForStable = (timeoutMs?: number) => Effect.gen(function* () {
