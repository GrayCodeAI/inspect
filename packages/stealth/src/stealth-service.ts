...
export class StealthService extends ServiceMap.Service<StealthService>()(
  "@stealth/StealthService",
  {
    make: Effect.gen(function* () {
      ...
      const initialize = Effect.fn("StealthService.initialize")(
        function* (config: StealthConfig) {
      ...
      const simulateHumanClick = Effect.fn("StealthService.simulateHumanClick")(
        function* (targetX: number, targetY: number) {
      ...
      const simulateHumanTyping = Effect.fn("StealthService.simulateHumanTyping")(
      ...
      const simulateHumanScroll = Effect.fn("StealthService.simulateHumanScroll")(
      ...
      const rotateAllFingerprints = Effect.fn("StealthService.rotateAllFingerprints")(
        function* () {
      ...
      const applyStealth = Effect.fn("StealthService.applyStealth")(
        function* () {
